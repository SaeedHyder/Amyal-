...
public class CarTypeBinder extends RecyclerViewBinder<FlightTypeEnt> {


    private ImageLoader imageLoader;
    private ItemClickListener itemClickListener;

    public CarTypeBinder(ItemClickListener itemClickListener) {
    ...
    public RecyclerViewBinder.BaseViewHolder createViewHolder(
            View view) {
        return new CarTypeBinder.ViewHolder(view);
    }

    @Override
    public void bindView(final FlightTypeEnt entity, final int position, Object viewHolder, Context context) {
        final CarTypeBinder.ViewHolder holder = (CarTypeBinder.ViewHolder) viewHolder;
