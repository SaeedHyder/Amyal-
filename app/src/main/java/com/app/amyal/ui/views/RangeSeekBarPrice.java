...
public class RangeSeekBarPrice<T extends Number> extends ImageView {
    /**
     * Default color of a {@link RangeSeekBarPrice}, #FF33B5E5. This is also known as "Ice Cream Sandwich" blue.
     */
    ...
    public RangeSeekBarPrice(Context context) {
        super(context);
        init(context, null);
    }

    public RangeSeekBarPrice(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public RangeSeekBarPrice(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        // make RangeSeekBarPrice focusable. This solves focus handling issues in case EditText widgets are being used along with the RangeSeekBarPrice within ScrollViews.
        setFocusable(true);
    ...
    protected synchronized void onDraw(@NonNull Canvas canvas) {
        ...
        if (showTextAboveThumbs && (activateOnDefaultValues || !selectedValuesAreDefault)) {
            ...
            String minText = currencyCode +valueToString(getSelectedMinValue());
            String maxText = currencyCode +valueToString(getSelectedMaxValue());
    ...
    /**
     * Overridden to save instance state when device orientation changes. This method is called automatically if you assign an id to the RangeSeekBarPrice widget using the {@link #setId(int)} method. Other members of this class than the normalized min and max values don't need to be saved.
     */
    @Override
    ...
    /**
     * Overridden to restore instance state when device orientation changes. This method is called automatically if you assign an id to the RangeSeekBarPrice widget using the {@link #setId(int)} method.
     */
    @Override
     ...
     *
     * @param <T> The Number type the RangeSeekBarPrice has been declared with.
     * @author Stephan Tittel (stephan.tittel@kom.tu-darmstadt.de)
     */
    public interface OnRangeSeekBarChangeListener<T extends Number> {

        void onRangeSeekBarValuesChanged(RangeSeekBarPrice<T> bar, T minValue, T maxValue);
    }
