...
public class CustomRecyclerView<T> extends RecyclerView {
    ...
    public void BindRecyclerView( RecyclerViewBinder<T> viewBinder, ArrayList<T> DataColloction, LayoutManager layoutManager, ItemAnimator animator) {
        this.userCollection = new ArrayList<>();
        mRecyclerViewAdapter = new RecyclerViewAdapter<>(DataColloction, viewBinder, getContext());
