...
public class GoogleMapOptions<T> implements GoogleMap.InfoWindowAdapter,GoogleMap.OnInfoWindowClickListener {
    ...
    private List<T> markerCollection;
    private InfoWindowBinder<T> infoWindowBinder;
    MapMarkerBinder<T> mapMarkerBinder;

    public GoogleMapOptions(Activity activity,GoogleMap googleMap, List<T> markerCollection, InfoWindowBinder<T> infoWindowBinder, MapMarkerBinder<T> mapMarkerBinder) {
